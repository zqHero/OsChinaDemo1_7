...
import com.hero.zhaoq.oschinademo1_7.common.BitmapManager;
import com.hero.zhaoq.oschinademo1_7.common.StringUtils;
import com.hero.zhaoq.oschinademo1_7.common.UIHelper;
import com.hero.zhaoq.oschinademo1_7.widget.LinkView;
...
public class ListViewCommentAdapter extends BaseAdapter {
	...
	public ListViewCommentAdapter(Context context, List<Comment> data,int resource) {
		...
		this.listItems = data;
		this.bmpManager = new BitmapManager(BitmapFactory.decodeResource(context.getResources(), R.mipmap.widget_dface_loading));
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(faceURL.endsWith("portrait.gif") || StringUtils.isEmpty(faceURL)){
			listItemView.face.setImageResource(R.mipmap.widget_dface);
		}else{
